...
const TIMELINE_ENTRIES = [
  ...
  // ═══════════════════════════════════════════
  // Phase 5: 练习系统 & 盲文读写训练  (06-28 ~ 06-30)
  // ═══════════════════════════════════════════
  {
    date: "2026-06-28 ~ 06-30",
    title: "Phase 5 — 练习系统 & 盲文读写训练",
    desc: "全新练习模式上线：全屏 overlay 双面板（题目 + 输入），支持数字/英文/拼音/标点四大题型，上下文感知防抖查找，写读镜像盲文对照。",
    milestone: true,
    tags: ["练习模式", "题型切换", "镜像盲文", "防抖查找"],
    hiTags: ["练习模式"],
  },
  {
    date: "06-28",
    title: "练习面板 MVP：双网格 + 数字题型",
    desc: "占满全屏的练习 overlay，左侧题目网格（只读）、右侧输入网格。数字随机出题，点位匹配成功触发蜂鸣 + 键位播报，自动切换下一题。Ctrl+Shift+E 快捷键入口。",
    tags: ["实践 overlay", "dot-grid x2", "匹配检测", "蜂鸣反馈"],
    hiTags: ["实践 overlay"],
  },
  {
    date: "06-29",
    title: "题型切换 & 上下文感知查找",
    desc: "新增题型选择栏（数字/英文/拼音/标点）。题库从 ONEHOT_MAPPINGS.categories 按类别自动构建。输入防抖查找按当前题型返回对应上下文字符，target preview 同步显示题型标签。",
    tags: ["题型切换", "题库构建", "上下文查找", "debounce"],
    hiTags: ["题型切换"],
  },
  {
    date: "06-30",
    title: "写读镜像盲文 & 预览布局优化",
    desc: "练习预览框升级为写/读双列盲文对照：写方镜像（左右列交换 [d4,d5,d6,d1,d2,d3]），读方正序。点位描述与标签移至盲文下方纵向排列，input 预览定高防布局跳动。",
    tags: ["镜像盲文", "写读对照", "布局防抖"],
    hiTags: ["镜像盲文"],
  },
];
