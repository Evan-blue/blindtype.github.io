...
function _buildSections() {
    ...
    const posText = getCurrentPresetPositionText('keyboard');
    const numpadPosText = getCurrentPresetPositionText('numpad');
    ...
    return [
        ...
        {
            title: '9、保存与打开',
            text: '按 Control+S 保存输出区的盲文文本为文本文件。按 Control+O 打开中文文本文件并渲染到输出区。',
        },
        {
            title: '10、键盘和设置',
