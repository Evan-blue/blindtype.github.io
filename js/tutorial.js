...
const TUTORIAL_SECTIONS = [
    ...
    {
        title: '5、光标与编辑',
        text: '输出区显示你已确认的盲文字符。用左右方向键移动光标，语音会播报光标前的内容。用上下方向键在空方之间快速跳转。按 D 键，或者小键盘的乘号键（星键）删除光标前一个字符，按退格键效果相同。按 Control+Z 撤销，按 Control+shift+Z 或Control+Y重做。另外，键盘上的退格键和DEL键也可以删除光标前后的字符。如果你想清空整个输出区，则可以按食指下方的 C 键。',
    },
    {
        title: '6、数字与英文',
